...
class JAAD(object):
    ...
    def _get_annotations(self, vid):
        ...
        annotations['width'] = int(tree.find('./meta_task/original_size/width').text)
    ...
    def _get_traffic_attributes(self, vid):
        ...
        tree = ET.parse(path_to_file)
        road_type = tree.find('./raod_type').text
    ...
    def _get_data_ids(self, image_set, params):
        '''
        A helper function to generate set id and ped ids (if needed) ofr processing
