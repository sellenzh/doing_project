...
def train(model, train_loader, valid_loader, criterion, optimizer, checkpoint_filepath, writer, epochs):
    ...
    for epoch in range(epochs):
        ...
        valid_loss, val_acc = evaluate(model, valid_loader, criterion)
