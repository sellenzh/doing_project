...
def train(model, train_loader, valid_loader, class_critirion, endp_critirion, 
    ...
    for epoch in range(args['epochs']):
        ...
        print("sigma_reg: " + str(sigma_endp.item()) + "\n")
        ...
        writer.add_scalar('training Reg loss', endp_losses / nb_batches_train, epoch + 1)        
        writer.add_scalar('training Acc', train_acc / nb_batches_train, epoch + 1)

        print(f"Epoch {epoch}: | Train_Full_Loss {full_losses / nb_batches_train} | Train_Class_Loss {class_losses / nb_batches_train} | Train_Reg_Loss {endp_losses / nb_batches_train} | Train_Acc {train_acc / nb_batches_train} ")
        ...
        writer.add_scalar('validation Reg loss', valid_endp_loss, epoch + 1) 
...
def evaluate(model, data_loader, cls_critirion, endp_critirion, args):
    ...
    print(f"Valid_Full_Loss {val_full_losses / nb_batches} | Valid_Class_Loss {val_class_losses / nb_batches} | Valid_Reg_Loss {val_endp_losses / nb_batches} | Valid_Acc {acc / nb_batches} \n")
