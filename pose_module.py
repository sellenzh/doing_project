...
from encoder_module import Encoder, GraphEncoder
...
class Pose_Module(nn.Module):
    ...
    def forward(self, pose):
        ...
        gat_out = x.contiguous().view(B*T, V, -1)
        ...
        for i in range(self.num_times):
            ...
            gat_out = self.gat_en[i](gat_out)
            gat_out = self.gat_de[i](gat_out)#[124, 19, 64]
        y = gat_out.contiguous().view(B*V, T, -1)#[38, 64/128, 62]
