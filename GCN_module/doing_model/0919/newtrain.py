...
def main(args):
    ...
    print(*['-']*30)
    print(f'Average run time of Pedestrian Graph +: {np.mean(timimg):.3f}')
    print('finish')


if __name__ == "__main__":
    parser = argparse.ArgumentParser("Pedestrian prediction crosing")
    parser.add_argument('--ckpt', type=str, default="./checkpoints/PedModel.pth", help="Path to model weigths")
